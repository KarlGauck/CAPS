...
class SedovSolution(object):
    ...
    """
    def __init__(self, e, rho, gamma=5/3., nu=3, w=0., epsilon=1e-50):
...
if __name__ == '__main__':
    ...
    ax1.plot(*sedov.compute('rho'), label="rho (analytical)")
    ...
    ax2.legend(loc='best')
    ax3.legend(loc='best')
    plt.savefig('sedov.png', dpi=150, bbox_inches='tight')
